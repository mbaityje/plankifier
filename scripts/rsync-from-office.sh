#!/bin/bash
#
# This script transfers the data folders from Marco's office PC to here (Siam20). The reason is that Marco's computer is connected to the disks with the data, whereas Siam20 is not.
#
